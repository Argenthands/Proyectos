...
if __name__ == '__main__':
    ...
    extra_video = Get_elements_from_directory('assets/videos/Input/')
    ...
    create_video(
        ...
        output_path='assets/videos/output/video.mp4')
    ...
    print(Remove_elements_from_the_directory('assets/videos/Input/'))
